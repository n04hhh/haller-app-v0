...
st.set_page_config(page_title="Photographic Haller Index", page_icon="🫁", layout="wide")

st.title("🫁 Photographic Haller Index — Beta")
st.markdown("**Cloud-compatible version** · 4 clicks per image · local dataset export")
...
def resize_image(image, width=DISPLAY_WIDTH):
    w, h = image.size
    if w <= width:
